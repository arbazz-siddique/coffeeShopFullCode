...
import {addNewMenu, clearAllMenuErrors, getAllMenu, resetMenuSlice} from"../store/slices/menuSlice"
...
const ManageMenu = () => {
  ...
  const { loading, error, message } = useSelector((state) => state.menu);
              ...
              <div className="mt-10 flex flex-col gap-5">
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <Textarea
                        placeholder="Example: A coffee with milk foam"
                        value={description}
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <Textarea
                        placeholder="like: Hot Beverages"
                        value={category}
